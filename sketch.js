...
function preload(){
   player1image=loadAnimation("mariostanding.png")
    backgroundimage=loadImage("background.jpg")
     player1image2=loadAnimation("marioimage.png")
     carimage=loadAnimation("car.png")
     heartimage=loadImage("heart.png")
     trophyimage=loadImage("trophy.png")
     stoneimage=loadImage("stone.png")
     fireimage=loadImage("fire.png")
     policeconesimage=loadImage("policecones.png")
     arcadeimage=loadImage("arcade.png")
     yesimage=loadImage("yes mage.png")
     textimage=loadImage("my game text.png")
  }
